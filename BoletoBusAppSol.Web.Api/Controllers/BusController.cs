...
namespace BoletoBusAppSol.Web.Api.Controllers
{
    public class BusController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                string urlBase = "http://localhost:7247/api/";

                client.BaseAddress = new Uri(urlBase);

                var responseTask = await client.GetAsync("https://localhost:7247/api/Bus/GetBuses");
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                var responseTask = await client.GetAsync($"https://localhost:7247/api/Bus/GetBusById?id={id}");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(UpdateBusModel updteBus)
        {
            ApiBaseModel apiBaseModel = new ApiBaseModel();
            try
            {
                string url = "http://localhost:7247/api/";
                ...
                using (var client = new HttpClient())
                {
                    ...
                    var responseTask = await client.PutAsJsonAsync<UpdateBusModel>("https://localhost:7247/api/Bus/UpdateBus", updteBus);
